...
import io.renren.modules.test.bean.DataSourceImpl;
...
public class ConnectionFactory
{
	 ...
	 */
	public static DataSource bind(String name, DataSourceEntity param)
	 ...
	 * @throws SQLException				无法正常连接指定的数据库
	 */
	public static DataSource rebind(String name, DataSourceEntity param)
		throws NameAlreadyBoundException,ClassNotFoundException,
				IllegalAccessException,InstantiationException,SQLException
	{
		try{
